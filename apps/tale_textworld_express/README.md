...
TextWorld-Express app for AGIAgent (single-action tool mode).

## Run One Session

```bash
cd /Users/apple/Desktop/ZiSuo/proj_03/AGIAgent
python agia.py --app tale_textworld_express
```
...
conda run -n tale-suite python AGIAgent/apps/tale_textworld_express/run_all_tasks.py
```
