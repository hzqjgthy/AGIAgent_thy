...
# -*- coding: utf-8 -*-
"""
Single-action TALE-Suite tool implementation for dataset: textworld_express
"""
...
class TaleTextworldExpressTools:
    DATASET_KEY = "textworld_express"
    TOOL_PREFIX = "tale_textworld_express"
    ...
    def tale_textworld_express_list_tasks(self, tale_suite_root: Optional[str] = None) -> Dict[str, Any]:
    ...
    def tale_textworld_express_action(
        self,
        action: str,
        env_name: str = "",
        task_index: int = 0,
