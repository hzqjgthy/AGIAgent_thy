...
# -*- coding: utf-8 -*-
"""
Single-action TALE-Suite tool implementation for dataset: textworld
"""
...
class TaleTextworldTools:
    DATASET_KEY = "textworld"
    TOOL_PREFIX = "tale_textworld"
    ...
    def tale_textworld_list_tasks(self, tale_suite_root: Optional[str] = None) -> Dict[str, Any]:
