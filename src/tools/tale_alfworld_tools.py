...
# -*- coding: utf-8 -*-
"""
Single-action TALE-Suite tool implementation for dataset: alfworld
"""
...
class TaleAlfworldTools:
    DATASET_KEY = "alfworld"
    TOOL_PREFIX = "tale_alfworld"
    ...
    def tale_alfworld_list_tasks(self, tale_suite_root: Optional[str] = None) -> Dict[str, Any]:
